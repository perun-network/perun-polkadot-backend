...
type (
	// Account defines the perun Account and substrate specific functions.
	Account interface {
		pwallet.Account

		substrate.ExtrinsicSigner
	}

	// Address defines the perun Address and substrate specific funcions.
	Address interface {
		pwallet.Address
...
// IsAddr returns whether an perun Address is an Address.
